...
public class Atividades {
    ...
    @RequestMapping(path = "/atividades/pesquisar/nome", method = RequestMethod.GET)
    ...
    @RequestMapping(path = "/atividades/{id}", method = RequestMethod.GET)
    public Atividade recuperar(@PathVariable int id) {
        return atividadeDAO.findOne(id);
    }

    @RequestMapping(path = "/atividades", method = RequestMethod.POST)
    ...
    @RequestMapping(path = "/atividades/{id}", method = RequestMethod.DELETE)
    ...
    @RequestMapping(path = "/atividades/{id}", method = RequestMethod.PUT)
    @ResponseStatus(HttpStatus.OK)
